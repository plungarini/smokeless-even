...
export function StatsPage({
	...
	statsSeries: Array<{ key: string; label: string; count: number }>;
	totalSmoked: number;
		...
		<div className="flex flex-col gap-4 pb-4">
			...
			<Card padding="default" className={`${glassCardClass} rounded-[32px]`}>
				<div className="flex flex-col gap-5">
					<div className="flex items-end justify-between gap-4">
						<div>
							<div className="text-detail uppercase tracking-[0.32em] text-text-dim">Total smoked</div>
			...
			<div className="grid grid-cols-2 gap-3">
				<Card padding="default" className={`${glassCardClass} rounded-[28px]`}>
					...
					<div className="mt-6 text-[3.5rem] font-semibold leading-none tracking-[-0.05em] text-text">{weightedAverage.toFixed(1)}</div>
