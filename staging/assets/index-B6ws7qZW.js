 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const K6=new Pr(5e3,15e3),Q6="__/auth/iframe",J6="emulator/auth/iframe",$6={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},W6=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function t4(e){const t=e.config;q(t.authDomain,e,"auth-domain-config-required");const i=t.emulator?j1(t,J6):`https://${e.config.authDomain}/${Q6}`,n={apiKey:t.apiKey,appName:e.name,v:Vs},l=W6.get(e.config.apiHost);l&&(n.eid=l);const s=e._getFrameworks();return s.length&&(n.fw=s.join(",")),`${i}?${Ur(n).slice(1)}`}async function e4(e){const t=await F6(e),i=li().gapi;return q(i,e,"internal-error"),t.open({where:document.body,url:t4(e),messageHandlersFilter:i.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:$6,dontclear:!0},n=>new Promise(async(l,s)=>{await n.restyle({setHideOnLeave:!1});const a=Ye(e,"network-request-failed"),o=li().setTimeout(()=>{s(a)},K6.get());function c(){li().clearTimeout(o),l(n)}n.ping(c).then(c,()=>{s(a)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const i4={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},n4=500,l4=600,s4="_blank",r4="http://localhost";class hd{constructor(t){this.window=t,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function a4(e,t,i,n=n4,l=l4){const s=Math.max((window.screen.availHeight-l)/2,0).toString(),a=Math.max((window.screen.availWidth-n)/2,0).toString();let o="";const c=Object.assign(Object.assign({},i4),{width:n.toString(),height:l.toString(),top:s,left:a}),d=se().toLowerCase();i&&(o=T3(d)?s4:i),S3(d)&&(t=t||r4,c.scrollbars="yes");const v=Object.entries(c).reduce((V,[b,C])=>`${V}${b}=${C},`,"");if(Gy(d)&&o!=="_self")return o4(t||"",o),new hd(null);const w=window.open(t||"",o,v);q(w,e,"popup-blocked");try{w.focus()}catch{}return new hd(w)}function o4(e,t){const i=document.createElement("a");i.href=e,i.target=t;const n=document.createEvent("MouseEvent");n.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),i.dispatchEvent(n)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const v2="webStorageSupport";class d4{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=X1,this._completeRedirectFn=Q3,this._overrideRedirectResult=B6}async _openPopup(t,i,n,l){var s;ki((s=this.eventManagers[t._key()])===null||s===void 0?void 0:s.manager,"_initialize() not called before _openPopup()");const a=await fd(t,i,n,_c(),l);return a4(t,a,F1())}async _openRedirect(t,i,n,l){await this._originValidation(t);const s=await fd(t,i,n,_c(),l);return g6(s),new Promise(()=>{})}_initialize(t){const i=t._key();if(this.eventManagers[i]){const{manager:l,promise:s}=this.eventManagers[i];return l?Promise.resolve(l):(ki(s,"If manager is not set, promise should be"),s)}const n=this.initAndGetManager(t);return this.eventManagers[i]={promise:n},n.catch(()=>{delete this.eventManagers[i]}),n}async initAndGetManager(t){const i=await e4(t),n=new I6(t);return i.register("authEvent",l=>(q(l==null?void 0:l.authEvent,t,"invalid-auth-event"),{status:n.onEvent(l.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[t._key()]={manager:n},this.iframes[t._key()]=i,n}_isIframeWebStorageSupported(t,i){this.iframes[t._key()].send(v2,{type:v2},l=>{var s;const a=(s=l==null?void 0:l[0])===null||s===void 0?void 0:s[v2];a!==void 0&&i(!!a),si(t,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(t){const i=t._key();return this.originValidationPromises[i]||(this.originValidationPromises[i]=G6(t)),this.originValidationPromises[i]}get _shouldInitProactively(){return N3()||E3()||q1()}}const $3=d4;var dd="@firebase/auth",Hd="1.10.8";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const p4=5*60,m4=f3("authIdTokenMaxAge")||p4;let Vd=null;const v4=e=>async t=>{const i=t&&await t.getIdTokenResult(),n=i&&(new Date().getTime()-Date.parse(i.issuedAtTime))/1e3;if(n&&n>m4)return;const l=i==null?void 0:i.token;Vd!==l&&(Vd=l,await fetch(e,{method:l?"POST":"DELETE",headers:l?{Authorization:`Bearer ${l}`}:{}}))};function M4(e=k1()){const t=jr(e,"auth");if(t.isInitialized())return t.getImmediate();const i=B3(e,{popupRedirectResolver:$3,persistence:[b6,U3,X1]}),n=f3("authTokenSyncURL");if(n&&typeof isSecureContext=="boolean"&&isSecureContext){const s=new URL(n,location.origin);if(location.origin===s.origin){const a=v4(s.toString());h6(i,a,()=>a(i.currentUser)),c6(i,o=>a(o))}}const l=u3("auth");return l&&i6(i,`http://${l}`),i}function y4(){var e,t;return(t=(e=document.getElementsByTagName("head"))===null||e===void 0?void 0:e[0])!==null&&t!==void 0?t:document}Jy({loadJS(e){return new Promise((t,i)=>{const n=document.createElement("script");n.setAttribute("src",e),n.onload=t,n.onerror=l=>{const s=Ye("internal-error");s.customData=l,i(s)},n.type="text/javascript",n.charset="UTF-8",y4().appendChild(n)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});g4("Browser");var w4="firebase",Z4="11.10.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ni(w4,Z4,"app");var gd=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ss=new D1("@firebase/firestore");function qe(e,...t){if(ss.logLevel<=rt.DEBUG){const i=t.map($1);ss.debug(`Firestore (${Yr}): ${e}`,...i)}}function W3(e,...t){if(ss.logLevel<=rt.ERROR){const i=t.map($1);ss.error(`Firestore (${Yr}): ${e}`,...i)}}function _4(e,...t){if(ss.logLevel<=rt.WARN){const i=t.map($1);ss.warn(`Firestore (${Yr}): ${e}`,...i)}}function $1(e){if(typeof e=="string")return e;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function C4(e){const t=typeof self<"u"&&(self.crypto||self.msCrypto),i=new Uint8Array(e);if(t&&typeof t.getRandomValues=="function")t.getRandomValues(i);else for(let n=0;n<e;n++)i[n]=Math.floor(256*Math.random());return i}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class N4{static newId(){const t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",i=62*Math.floor(4.129032258064516);let n="";for(;n.length<20;){const l=C4(40);for(let s=0;s<l.length;++s)n.length<20&&l[s]<i&&(n+=t.charAt(l[s]%62))}return n}}function Xe(e,t){return e<t?-1:e>t?1:0}function R4(e,t){let i=0;for(;i<e.length&&i<t.length;){const n=e.codePointAt(i),l=t.codePointAt(i);if(n!==l){if(n<128&&l<128)return Xe(n,l);{const s=O4(),a=B4(s.encode(Md(e,i)),s.encode(Md(t,i)));return a!==0?a:Xe(n,l)}}i+=n>65535?2:1}return Xe(e.length,t.length)}function Md(e,t){return e.codePointAt(t)>65535?e.substring(t,t+2):e.substring(t,t+1)}function B4(e,t){for(let i=0;i<e.length&&i<t.length;++i)if(e[i]!==t[i])return Xe(e[i],t[i]);return Xe(e.length,t.length)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qn{constructor(t){this.path=t}static fromPath(t){return new qn(Pe.fromString(t))}static fromName(t){return new qn(Pe.fromString(t).popFirst(5))}static empty(){return new qn(Pe.emptyPath())}get collectionGroup(){return this.path.popLast().lastSegment()}hasCollectionId(t){return this.path.length>=2&&this.path.get(this.path.length-2)===t}getCollectionGroup(){return this.path.get(this.path.length-2)}getCollectionPath(){return this.path.popLast()}isEqual(t){return t!==null&&Pe.comparator(this.path,t.path)===0}toString(){return this.path.toString()}static comparator(t,i){return Pe.comparator(t.path,i.path)}static isDocumentKey(t){return t.length%2==0}static fromSegments(t){return new qn(new Pe(t.slice()))}}function L4(e,t,i,n){if(t===!0&&n===!0)throw new W($.INVALID_ARGUMENT,`${e} and ${i} cannot be used together.`)}function k4(e){return typeof e=="object"&&e!==null&&(Object.getPrototypeOf(e)===Object.prototype||Object.getPrototypeOf(e)===null)}function I4(e){if(e===void 0)return"undefined";if(e===null)return"null";if(typeof e=="string")return e.length>20&&(e=`${e.substring(0,20)}...`),JSON.stringify(e);if(typeof e=="number"||typeof e=="boolean")return""+e;if(typeof e=="object"){if(e instanceof Array)return"an array";{const t=function(n){return n.constructor?n.constructor.name:null}(e);return t?`a custom ${t} object`:"an object"}}return typeof e=="function"?"a function":Sr(12329,{type:typeof e})}function z4(e,t){if("_delegate"in e&&(e=e._delegate),!(e instanceof t)){if(t.name===e.constructor.name)throw new W($.INVALID_ARGUMENT,"Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");{const i=I4(e);throw new W($.INVALID_ARGUMENT,`Expected type '${t.name}', but it was: ${i}`)}}return e}/**
 * @license
 * Copyright 2025 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rt(e,t){const i={typeString:e};return t&&(i.value=t),i}function Xr(e,t){if(!k4(e))throw new W($.INVALID_ARGUMENT,"JSON must be an object");let i;for(const n in t)if(t[n]){const l=t[n].typeString,s="value"in t[n]?{value:t[n].value}:void 0;if(!(n in e)){i=`JSON missing required field: '${n}'`;break}const a=e[n];if(l&&typeof a!==l){i=`JSON field '${n}' must be a ${l}.`;break}if(s!==void 0&&a!==s.value){i=`Expected '${n}' field to equal '${s.value}'`;break}}if(i)throw new W($.INVALID_ARGUMENT,i);return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class P4{constructor(t,i=null,n=[],l=[],s=null,a="F",o=null,c=null){this.path=t,this.collectionGroup=i,this.explicitOrderBy=n,this.filters=l,this.limit=s,this.limitType=a,this.startAt=o,this.endAt=c,this.Te=null,this.Ie=null,this.de=null,this.startAt,this.endAt}}function G4(e){return new P4(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function X4(e){const t={};return e.timeoutSeconds!==void 0&&(t.timeoutSeconds=e.timeoutSeconds),t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const iw="type.googleapis.com/google.protobuf.Int64Value",nw="type.googleapis.com/google.protobuf.UInt64Value";function op(e,t){const i={};for(const n in e)e.hasOwnProperty(n)&&(i[n]=t(e[n]));return i}function Do(e){if(e==null)return null;if(e instanceof Number&&(e=e.valueOf()),typeof e=="number"&&isFinite(e)||e===!0||e===!1||Object.prototype.toString.call(e)==="[object String]")return e;if(e instanceof Date)return e.toISOString();if(Array.isArray(e))return e.map(t=>Do(t));if(typeof e=="function"||typeof e=="object")return op(e,t=>Do(t));throw new Error("Data cannot be encoded in JSON: "+e)}function rs(e){if(e==null)return e;if(e["@type"])switch(e["@type"]){case iw:case nw:{const t=Number(e.value);if(isNaN(t))throw new Error("Data cannot be decoded from JSON: "+e);return t}default:throw new Error("Data cannot be decoded from JSON: "+e)}return Array.isArray(e)?e.map(t=>rs(t)):typeof e=="function"||typeof e=="object"?op(e,t=>rs(t)):e}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rd={OK:"ok",CANCELLED:"cancelled",UNKNOWN:"unknown",INVALID_ARGUMENT:"invalid-argument",DEADLINE_EXCEEDED:"deadline-exceeded",NOT_FOUND:"not-found",ALREADY_EXISTS:"already-exists",PERMISSION_DENIED:"permission-denied",UNAUTHENTICATED:"unauthenticated",RESOURCE_EXHAUSTED:"resource-exhausted",FAILED_PRECONDITION:"failed-precondition",ABORTED:"aborted",OUT_OF_RANGE:"out-of-range",UNIMPLEMENTED:"unimplemented",INTERNAL:"internal",UNAVAILABLE:"unavailable",DATA_LOSS:"data-loss"};class he extends oi{constructor(t,i,n){super(`${ih}/${t}`,i||""),this.details=n,Object.setPrototypeOf(this,he.prototype)}}function lw(e){if(e>=200&&e<300)return"ok";switch(e){case 0:return"internal";case 400:return"invalid-argument";case 401:return"unauthenticated";case 403:return"permission-denied";case 404:return"not-found";case 409:return"aborted";case 429:return"resource-exhausted";case 499:return"cancelled";case 500:return"internal";case 501:return"unimplemented";case 503:return"unavailable";case 504:return"deadline-exceeded"}return"unknown"}function Lo(e,t){let i=lw(e),n=i,l;try{const s=t&&t.error;if(s){const a=s.status;if(typeof a=="string"){if(!Rd[a])return new he("internal","internal");i=Rd[a],n=a}const o=s.message;typeof o=="string"&&(n=o),l=s.details,l!==void 0&&(l=rs(l))}}catch{}return i==="ok"?null:new he(i,n,l)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sw{constructor(t,i,n,l){this.app=t,this.auth=null,this.messaging=null,this.appCheck=null,this.serverAppAppCheckToken=null,ve(t)&&t.settings.appCheckToken&&(this.serverAppAppCheckToken=t.settings.appCheckToken),this.auth=i.getImmediate({optional:!0}),this.messaging=n.getImmediate({optional:!0}),this.auth||i.get().then(s=>this.auth=s,()=>{}),this.messaging||n.get().then(s=>this.messaging=s,()=>{}),this.appCheck||l==null||l.get().then(s=>this.appCheck=s,()=>{})}async getAuthToken(){if(this.auth)try{const t=await this.auth.getToken();return t==null?void 0:t.accessToken}catch{return}}async getMessagingToken(){if(!(!this.messaging||!("Notification"in self)||Notification.permission!=="granted"))try{return await this.messaging.getToken()}catch{return}}async getAppCheckToken(t){if(this.serverAppAppCheckToken)return this.serverAppAppCheckToken;if(this.appCheck){const i=t?await this.appCheck.getLimitedUseToken():await this.appCheck.getToken();return i.error?null:i.token}return null}async getContext(t){const i=await this.getAuthToken(),n=await this.getMessagingToken(),l=await this.getAppCheckToken(t);return{authToken:i,messagingToken:n,appCheckToken:l}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pw="auth-internal",mw="app-check-internal",vw="messaging-internal";function Mw(e){const t=(i,{instanceIdentifier:n})=>{const l=i.getProvider("app").getImmediate(),s=i.getProvider(pw),a=i.getProvider(vw),o=i.getProvider(mw);return new ow(l,s,a,o,n)};ll(new En(ih,t,"PUBLIC").setMultipleInstances(!0)),ni(Bd,Dd,e),ni(Bd,Dd,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yw(e=k1(),t=Ec){const n=jr(Ke(e),ih).getImmediate({identifier:t}),l=c3("functions");return l&&ww(n,...l),n}function ww(e,t,i){uw(Ke(e),t,i)}function nh(e,t,i){return cw(Ke(e),t)}Mw();const cp={firebaseConfig:{apiKey:"AIzaSyCdopZ7PgYFx82A0lC_lLeKtEXepYUd4Pw",authDomain:"smokeless-eu.firebaseapp.com",projectId:"smokeless-eu",storageBucket:"smokeless-eu.firebasestorage.app",messagingSenderId:"1096722867612",appId:"1:1096722867612:web:19176df5b5a4e443f65459"},firebaseFunctionsRegion:"europe-west1"},Er=X0().length>0?X0()[0]:V3(cp.firebaseConfig);let Tc;try{Tc=B3(Er,{persistence:U3,popupRedirectResolver:$3})}catch{Tc=M4(Er)}const Ue=Tc;let Ld;try{Ld=Q4(Er,{experimentalAutoDetectLongPolling:!0})}catch{Ld=J4(Er)}const lh=yw(Er,cp.firebaseFunctionsRegion);async function Zw(e){return(await nh(lh,"resolveGoogleLinkCode")({code:e})).data}async function kd(e){return(await nh(lh,"completeGoogleLinkSession")({sessionId:e})).data}async function Id(e){return(await nh(lh,"consumeGoogleLinkSession")({sessionId:e})).data}const Ac="smokeless:link-site:session";function hp(e){return e.toUpperCase().replace(/[^A-Z2-9]/g,"").slice(0,10)}function _w(e){const t=hp(e);return t.length<=5?t:`${t.slice(0,5)}-${t.slice(5)}`}function zd(){if(typeof window>"u")return null;try{const e=window.sessionStorage.getItem(Ac);if(!e)return null;const t=JSON.parse(e);return typeof t.sessionId!="string"||typeof t.expiresAt!="string"?null:{sessionId:t.sessionId,expiresAt:t.expiresAt}}catch{return null}}function Aa(e){if(!(typeof window>"u")){if(!e){window.sessionStorage.removeItem(Ac);return}window.sessionStorage.setItem(Ac,JSON.stringify(e))}}function bw(){if(typeof navigator>"u")return!1;const e=navigator.userAgent,t=/iPad|iPhone|iPod/.test(e),i=/Safari/.test(e)&&!/Chrome|CriOS|Edg|FxiOS/.test(e);return t||i}function Sw(e){if(!e||typeof e!="object"||!("code"in e))return!1;const t=String(e.code??"");return t==="auth/popup-blocked"||t==="auth/web-storage-unsupported"||t==="auth/operation-not-supported-in-this-environment"}function Ew(e){const t=Math.max(0,e),i=Math.floor(t/60),n=t%60;return`${i}:${String(n).padStart(2,"0")}`}function Tw(){const[e,t]=Vt.useState(""),[i,n]=Vt.useState("idle"),[l,s]=Vt.useState(()=>zd()),[a,o]=Vt.useState("Enter the pairing code from Smokeless to continue."),[c,d]=Vt.useState(""),[v,w]=Vt.useState(!1),[V,b]=Vt.useState(()=>Date.now());Vt.useEffect(()=>{const p=window.setInterval(()=>b(Date.now()),1e3);return()=>window.clearInterval(p)},[]),Vt.useEffect(()=>{let p=!1;return(async()=>{await u6(Ue,X1);const A=zd(),D=await L6(Ue);if(!p){if(D!=null&&D.user&&A){s(A),n("authorizing"),o("Finalizing your Google link...");try{const I=await kd(A.sessionId);if(await Id(A.sessionId),p)return;d(I.targetGoogleEmail??D.user.email??""),w(!1),n("success"),o("Google account linked successfully. Return to Smokeless to continue."),Aa(null),s(null),await sd(Ue)}catch(I){if(console.error("[Smokeless Link] redirect completion failed",I),p)return;d(D.user.email??""),w(!0),n("error"),o(I instanceof Error?I.message:"Google access was approved, but Smokeless could not finish linking.")}return}if(Ue.currentUser&&A){s(A),n("ready"),o("Continue with Google to finish linking.");return}A&&(s(A),n("ready"),o("Continue with Google to finish linking."))}})().catch(A=>{console.error("[Smokeless Link] initialization failed",A),!p&&(n("error"),o(A instanceof Error?A.message:"Could not start the Google link page."))}),()=>{p=!0}},[]);const C=Vt.useMemo(()=>l?Math.max(0,Math.floor((new Date(l.expiresAt).getTime()-V)/1e3)):0,[V,l]),N=async()=>{const p=hp(e);if(p.length!==10){w(!1),n("error"),o("Enter the full 10-character code shown in Smokeless.");return}w(!1),n("authorizing"),o("Checking pairing code...");try{const _=await Zw(p),A={sessionId:_.sessionId,expiresAt:_.expiresAt};Aa(A),s(A),n("ready"),o("Code verified. Continue with Google in this browser.")}catch(_){console.error("[Smokeless Link] resolve failed",_),w(!1),n("error"),o(_ instanceof Error?_.message:"Pairing code not recognized.")}},B=async()=>{if(!l)return;const p=new wi;p.setCustomParameters({prompt:"select_account"}),Aa(l),w(!1),n("authorizing"),o("Opening Google sign-in...");try{if(bw()){await od(Ue,p);return}const _=await x6(Ue,p),A=await kd(l.sessionId);await Id(l.sessionId),d(A.targetGoogleEmail??_.user.email??""),w(!1),n("success"),o("Google account linked successfully. Return to Smokeless to continue."),Aa(null),s(null),await sd(Ue)}catch(_){if(Sw(_)){await od(Ue,p);return}console.error("[Smokeless Link] google auth failed",_),Ue.currentUser&&(d(Ue.currentUser.email??c),w(!0)),n("error"),o(_ instanceof Error?_.message:Ue.currentUser?"Google access was approved, but Smokeless could not finish linking.":"Could not complete Google sign-in.")}},Z=i==="success"||v;return Y.jsxs("div",{className:"linker-shell",children:[Y.jsx("div",{className:"linker-orb linker-orb-left"}),Y.jsx("div",{className:"linker-orb linker-orb-right"}),Y.jsx("div",{className:"linker-frame",children:Y.jsxs(s3,{padding:"default",className:"linker-card",children:[Y.jsx("div",{className:"linker-eyebrow",children:"Smokeless Pairing"}),Y.jsx("h1",{className:"linker-title",children:"Link your Google account in a normal browser."}),Y.jsx("p",{className:"linker-body",children:a}),c?Y.jsxs("div",{className:"linker-chip",children:[i==="success"?"Linked as ":"Authorized as ",c]}):null,Z?null:Y.jsxs(Y.Fragment,{children:[Y.jsxs("div",{className:"linker-section",children:[Y.jsx("label",{className:"linker-label",htmlFor:"pairing-code",children:"Pairing code"}),Y.jsx("input",{id:"pairing-code",className:"linker-input",value:_w(e),onChange:p=>t(p.currentTarget.value),placeholder:"ABCDE-FGHIJ",autoComplete:"one-time-code",autoCapitalize:"characters",spellCheck:!1,disabled:i==="authorizing"}),Y.jsx(mc,{variant:"secondary",className:"linker-button",onClick:()=>void N(),disabled:i==="authorizing",children:"Verify code"})]}),l?Y.jsxs("div",{className:"linker-session",children:[Y.jsxs("div",{children:[Y.jsx("div",{className:"linker-label",children:"Session"}),Y.jsx("div",{className:"linker-meta",children:l.sessionId})]}),Y.jsxs("div",{children:[Y.jsx("div",{className:"linker-label",children:"Expires in"}),Y.jsx("div",{className:"linker-countdown",children:Ew(C)})]})]}):null,Y.jsx(mc,{variant:"highlight",className:"linker-button linker-button-primary",onClick:()=>void B(),disabled:!l||i==="authorizing"||C===0,children:"Continue with Google"})]}),Y.jsx("div",{className:"linker-footer",children:Z?"Return to Smokeless on your phone. The app will refresh onto the linked Google account automatically.":"After Google confirms access here, Smokeless will finish linking in this browser and then refresh on your phone."})]})})]})}I9.createRoot(document.getElementById("root")).render(Y.jsx(Tw,{}));
